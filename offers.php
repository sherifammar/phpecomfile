<?php
include "./connect.php";
$stmt = $con->prepare("SELECT items1view.* , 1 as favorite , (items_price -(items_price * items_discount/100)) AS itempricediscount FROM items1view 
...
WHERE  items_discount != 0 AND items_id NOT IN (SELECT items1view.items_id FROM items1view
 INNER JOIN favorite ON items1view.items_id= favorite.favorite_itemsid )");
